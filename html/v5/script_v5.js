...
// Créer une variable pour stocker les Pokémon filtrés
let filteredPokemon = Pokemon.all_pokemon;
...
function afficherPokemon(offset, filters) {
    ...
    filteredPokemon = Pokemon.all_pokemon;
}
...
function addFilterOptions() {
    // Récupérer toutes les générations et les types de Pokémon sauf undefined
